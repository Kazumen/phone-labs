...
var routes = [
  ...
  {
    path: "lab1",
    loadComponent: () => import("./chunk-QRF52MNF.js").then((m) => m.Lab1Component)
  },
  {
    path: "lab2",
    loadComponent: () => import("./chunk-2TJHQAW3.js").then((m) => m.Lab2Component)
  },
  {
    path: "lab3",
    loadComponent: () => import("./chunk-4GSVTZWR.js").then((m) => m.Lab3Component)
  },
  {
    path: "lab4",
    loadComponent: () => import("./chunk-ZPOOL3PK.js").then((m) => m.Lab4Component)
  },
  {
    path: "lab5",
    loadComponent: () => import("./chunk-BBWUK4TR.js").then((m) => m.Lab5Component)
  },
  {
    path: "lab6",
    loadComponent: () => import("./chunk-NOIRGA7T.js").then((m) => m.Lab6Component)
  }
];
...
function App_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 9)(5, "span", 10);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const lab_r1 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c0, "/lab" + lab_r1.id));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(lab_r1.id);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(lab_r1.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(lab_r1.subtitle);
  }
}
var App = class _App {
  labs = [
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 14, vars: 0, consts: [[1, "app-shell"], [1, "sidebar"], [1, "logo"], [1, "logo-icon"], [1, "logo-text"], [1, "nav-list"], [1, "content"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink"], [1, "nav-num"], [1, "nav-info"], [1, "nav-title"], [1, "nav-sub"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(10, App_For_11_Template, 9, 6, "li", null, _forTrack0);
      \u0275\u0275elementEnd()();
  ...
  }, dependencies: [RouterOutlet, RouterLink, RouterLinkActive], styles: ["\n.app-shell[_ngcontent-%COMP%] {\n  display: flex;\n  height: 100dvh;\n  overflow: hidden;\n}\n.sidebar[_ngcontent-%COMP%] {\n  width: 190px;\n  flex-shrink: 0;\n  background: var(--surface);\n  border-right: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  padding-bottom: 16px;\n}\n.logo[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  padding: 18px 14px 12px;\n  border-bottom: 1px solid var(--border);\n  margin-bottom: 8px;\n  font-size: 0.85rem;\n  color: var(--muted);\n}\n.logo[_ngcontent-%COMP%]   .logo-icon[_ngcontent-%COMP%] {\n  font-size: 1.3rem;\n}\n.logo[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  color: var(--accent);\n}\n.nav-list[_ngcontent-%COMP%] {\n  list-style: none;\n  padding: 0 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.nav-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 9px 10px;\n  border-radius: 10px;\n  text-decoration: none;\n  color: var(--muted);\n  transition: background 0.15s, color 0.15s;\n}\n.nav-item[_ngcontent-%COMP%]:hover {\n  background: var(--surface2);\n  color: var(--text);\n}\n.nav-item.active[_ngcontent-%COMP%] {\n  background: rgba(6, 182, 212, 0.12);\n  color: var(--accent);\n}\n.nav-item.active[_ngcontent-%COMP%]   .nav-num[_ngcontent-%COMP%] {\n  background: var(--accent);\n  color: #0f172a;\n}\n.nav-num[_ngcontent-%COMP%] {\n  width: 24px;\n  height: 24px;\n  border-radius: 7px;\n  background: var(--border);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 0.75rem;\n  font-weight: 700;\n  flex-shrink: 0;\n  transition: background 0.15s, color 0.15s;\n}\n.nav-info[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.nav-title[_ngcontent-%COMP%] {\n  font-size: 0.78rem;\n  font-weight: 600;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.nav-sub[_ngcontent-%COMP%] {\n  font-size: 0.65rem;\n  color: var(--muted);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.content[_ngcontent-%COMP%] {\n  flex: 1;\n  overflow-y: auto;\n  padding: 20px;\n}\n@media (max-width: 600px) {\n  .app-shell[_ngcontent-%COMP%] {\n    flex-direction: column;\n  }\n  .sidebar[_ngcontent-%COMP%] {\n    width: 100%;\n    height: auto;\n    flex-direction: row;\n    overflow-x: auto;\n    overflow-y: hidden;\n    border-right: none;\n    border-bottom: 1px solid var(--border);\n    padding-bottom: 0;\n  }\n  .logo[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .nav-list[_ngcontent-%COMP%] {\n    flex-direction: row;\n    padding: 6px 8px;\n    gap: 4px;\n  }\n  .nav-item[_ngcontent-%COMP%] {\n    flex-direction: column;\n    gap: 2px;\n    padding: 6px 8px;\n    min-width: 52px;\n    flex-shrink: 0;\n  }\n  .nav-info[_ngcontent-%COMP%] {\n    align-items: center;\n  }\n  .nav-sub[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .nav-title[_ngcontent-%COMP%] {\n    font-size: 0.68rem;\n  }\n  .content[_ngcontent-%COMP%] {\n    padding: 12px;\n  }\n}\n/*# sourceMappingURL=app.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", imports: [RouterOutlet, RouterLink, RouterLinkActive], template: '<div class="app-shell">\n  <nav class="sidebar">\n    <div class="logo">\n      <span class="logo-icon">\u{1F4F1}</span>\n      <span class="logo-text">Var <strong>13</strong></span>\n    </div>\n    <ul class="nav-list">\n      @for (lab of labs; track lab.id) {\n        <li>\n          <a class="nav-item" [routerLink]="[&quot;/lab&quot; + lab.id]" routerLinkActive="active">\n            <span class="nav-num">{{ lab.id }}</span>\n            <span class="nav-info">\n              <span class="nav-title">{{ lab.title }}</span>\n              <span class="nav-sub">{{ lab.subtitle }}</span>\n            </span>\n          </a>\n        </li>\n      }\n    </ul>\n  </nav>\n  <main class="content">\n    <router-outlet />\n  </main>\n</div>\r\n', styles: ["/* src/app/app.scss */\n.app-shell {\n  display: flex;\n  height: 100dvh;\n  overflow: hidden;\n}\n.sidebar {\n  width: 190px;\n  flex-shrink: 0;\n  background: var(--surface);\n  border-right: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n  padding-bottom: 16px;\n}\n.logo {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  padding: 18px 14px 12px;\n  border-bottom: 1px solid var(--border);\n  margin-bottom: 8px;\n  font-size: 0.85rem;\n  color: var(--muted);\n}\n.logo .logo-icon {\n  font-size: 1.3rem;\n}\n.logo strong {\n  color: var(--accent);\n}\n.nav-list {\n  list-style: none;\n  padding: 0 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 9px 10px;\n  border-radius: 10px;\n  text-decoration: none;\n  color: var(--muted);\n  transition: background 0.15s, color 0.15s;\n}\n.nav-item:hover {\n  background: var(--surface2);\n  color: var(--text);\n}\n.nav-item.active {\n  background: rgba(6, 182, 212, 0.12);\n  color: var(--accent);\n}\n.nav-item.active .nav-num {\n  background: var(--accent);\n  color: #0f172a;\n}\n.nav-num {\n  width: 24px;\n  height: 24px;\n  border-radius: 7px;\n  background: var(--border);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 0.75rem;\n  font-weight: 700;\n  flex-shrink: 0;\n  transition: background 0.15s, color 0.15s;\n}\n.nav-info {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.nav-title {\n  font-size: 0.78rem;\n  font-weight: 600;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.nav-sub {\n  font-size: 0.65rem;\n  color: var(--muted);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.content {\n  flex: 1;\n  overflow-y: auto;\n  padding: 20px;\n}\n@media (max-width: 600px) {\n  .app-shell {\n    flex-direction: column;\n  }\n  .sidebar {\n    width: 100%;\n    height: auto;\n    flex-direction: row;\n    overflow-x: auto;\n    overflow-y: hidden;\n    border-right: none;\n    border-bottom: 1px solid var(--border);\n    padding-bottom: 0;\n  }\n  .logo {\n    display: none;\n  }\n  .nav-list {\n    flex-direction: row;\n    padding: 6px 8px;\n    gap: 4px;\n  }\n  .nav-item {\n    flex-direction: column;\n    gap: 2px;\n    padding: 6px 8px;\n    min-width: 52px;\n    flex-shrink: 0;\n  }\n  .nav-info {\n    align-items: center;\n  }\n  .nav-sub {\n    display: none;\n  }\n  .nav-title {\n    font-size: 0.68rem;\n  }\n  .content {\n    padding: 12px;\n  }\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {
